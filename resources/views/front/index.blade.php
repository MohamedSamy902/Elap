...
<head>
    ...
    <meta property="og:image:height" content="600Quiety">
    ...
    <!--build:css-->
    <link rel="stylesheet" href="{{ asset('front') }}/assets/css/main-rtl.css">
...
<body>
    ...
    <div id="preloader">
        <div class="preloader-wrap">
            <img src="{{ asset('front') }}/assets/img/favicon.png" alt="logo" class="img-fluid preloader-icon" />
    ...
    <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-xl navbar-dark sticky-header">
                <div class="container d-flex align-items-center justify-content-lg-between position-relative">
                    <a href="{{ url('/') }}"
                        ...
                        <img src="{{ asset('front') }}/assets/img/logo-white.png" alt="logo"
                            class="img-fluid logo-white" />
                        <img src="{{ asset('front') }}/assets/img/logo-color.png" alt="logo"
                    ...
                    <div class="collapse navbar-collapse justify-content-center">
                        <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="front/about-us.html">About</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="front/services.html" class="nav-link dropdown-toggle">Services</a>
                                <div class="dropdown-menu border-0 rounded-custom shadow bg-white">
                                    <div class="dropdown-grid rounded-custom ">
                                        <div class="dropdown-grid-item">
                                            <a href="front/support-single.html" class="dropdown-link">
                            ...
                            <li class="nav-item dropdown">
                                <a href="front/support.html" class="nav-link dropdown-toggle">Support</a>
                                <div class="dropdown-menu border-0 rounded-custom shadow bg-white">
                                    <div class="dropdown-grid rounded-custom ">
                                        <div class="dropdown-grid-item">
                                            <a href="front/support-single.html" class="dropdown-link">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="front/contact-us.html">Contact</a>
                            </li>
                        </ul>
                    </div>

                    <div class="action-btns text-end me-5 me-lg-0 d-none d-md-block d-lg-block">
                        <a href="front/login.html" class="btn btn-link text-decoration-none me-2">Sign In</a>
                        <a href="front/request-demo.html" class="btn btn-primary">Get Started</a>
                    </div>
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="action-btns mt-4 ps-3">
                                <a href="front/login.html" class="btn btn-outline-primary me-2">Sign In</a>
                                <a href="front/request-demo.html" class="btn btn-primary">Get Started</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center text-center text-lg-start align-items-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0" style="text-align: right;">
                            <h1 class="fw-bold display-5" data-aos="fade-up">Build Better App with Quiety Software</h1>
                            <p class="lead" data-aos="fade-up">Proactively coordinate quality quality vectors
                                vis-a-vis
                                supply chains. Quickly engage client-centric web services.</p>
                            <div class="action-btns mt-5" data-aos="fade-up" data-aos-delay="50">
                                <a href="front/request-demo.html" class="btn btn-primary me-lg-3 me-sm-3">Request
                                    Demo</a>
                                <a href="front/contact-us.html" class="btn btn-outline-light">Contact Us</a>
                            </div>
                            <ul class="nav subscribe-feature-list d-flex justify-content-center justify-content-lg-start w-100 mt-3"
                                data-aos="fade-up" data-aos-delay="100">
                                <li class="nav-item">
                                    <span class="ms-0"><i class="far fa-check-circle text-white me-2"></i>Free
                                        14-day
                                        trial</span>
                                </li>
                                <li class="nav-item">
                                    <span><i class="far fa-check-circle text-white me-2"></i>No credit card
                                        required</span>
                                </li>
                            </ul>

                            <div class="d-flex justify-content-center justify-content-lg-start mt-5" data-aos="fade-up"
                                data-aos-delay="150">
                                <img src="{{ asset('front') }}/assets/img/awards-01.svg" alt="awards"
                                    class="me-4 img-fluid">
                                <img src="{{ asset('front') }}/assets/img/awards-02.svg" alt="awards"
                                    class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="hero-img-wrap position-relative app-screen-bg mt-5"
                            style="background-image: url('assets/img/shape/shape-bg-3.svg')" data-aos="fade-up"
                            data-aos-delay="200">
                            <!--animated shape start-->
                            <ul
                                class="position-absolute animate-element parallax-element shape-service d-none d-lg-block">
                                <li class="layer" data-depth="0.03">
                                    <img src="{{ asset('front') }}/assets/img/color-shape/image-4.svg" alt="shape"
                            ...
                            <!--animated shape end-->
                            <img src="{{ asset('front') }}/assets/img/screen/app-screen-on-hand.png" alt="hero image"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="position-relative" data-aos="fade-up" data-aos-delay="50">
                            <div
                                ...
                                <p class="mb-0">Professionally integrate high standards applications before
                                    user
                                    friendly leadership skills.</p>
                            </div>
                            <!--pattern start-->
                            <div class="dot-shape-bg position-absolute z--1 left--40 top--40">
                                <img src="{{ asset('front') }}/assets/img/shape/dot-big-square.svg" alt="shape">
                            </div>
                            <!--pattern end-->
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 order-lg-2 mb-7 mb-lg-0">
                        <div class="mb-4" data-aos="fade-up">
                            ...
                            <p>Conveniently drive stand-alone total linkage for process-centric content enthusiastically
                                administrate. Dramatically grow high standards in customer service for applications.</p>
                        </div>
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="pr-lg-4 position-relative" data-aos="fade-up">
                            ...
                            <ul
                                ...
                                <li class="layer" data-depth="0.03">
                                    <img src="{{ asset('front') }}/assets/img/color-shape/image-2.svg" alt="shape"
                                        class="img-fluid position-absolute color-shape-1">
                                </li>
                                <li class="layer" data-depth="0.02">
                                    <img src="{{ asset('front') }}/assets/img/color-shape/feature-2.svg" alt="shape"
                            ...
                            <div
                                ...
                                <div class="mb-5">
                                    <h3 class="fw-medium h4">Best options to choose a Quiety, to make your own app
                                        and
                                        grow your business</h3>
                                </div>
                                <div class="position-relative w-75 mx-auto">
                                    <img class="position-relative z-2 w-100 h-auto"
                                        src="{{ asset('front') }}/assets/img/screen/half-iphone.svg"
                                        alt="Image Description">
                                    <img class="position-absolute half-screen"
                                        src="{{ asset('front') }}/assets/img/screen/app-screen-1.jpg"
                                        alt="Image Description">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-lg-center justify-content-between">
                    <div class="col-lg-5 mb-7 mb-lg-0">
                        <div class="mb-4" data-aos="fade-up">
                            ...
                            <p>Enthusiastically administrate robust initiatives quickly unleash collaborative with
                                client-focused paradigms. Re-engineer granular innovation rather than best-of-breed
                                processes. </p>
                        </div>
                        <ul class="list-unstyled d-flex flex-wrap list-two-col mt-5" data-aos="fade-up">
                            <li>
                                <span class="d-block mb-4"><i
                                        class="fal fa-fingerprint fa-2x text-primary"></i></span>
                                <h3 class="h5">Humans on hand</h3>
                                <p>Objectively exceptional via customized via expertise.</p>
                            </li>
                            <li>
                                <span class="d-block mb-4"><i
                                        class="fal fa-shield-check fa-2x text-primary"></i></span>
                    ...
                    <div class="col-lg-6">
                        <div class="pr-lg-4 position-relative" data-aos="fade-up">
                            ...
                            <ul
                                class="position-absolute animate-element parallax-element shape-service z--1 hide-medium">
                                <li class="layer" data-depth="0.03">
                                    <img src="{{ asset('front') }}/assets/img/color-shape/image-3.svg" alt="shape"
                                        class="img-fluid position-absolute color-shape-1">
                                </li>
                                <li class="layer" data-depth="0.02">
                                    <img src="{{ asset('front') }}/assets/img/color-shape/feature-1.svg" alt="shape"
                                        class="img-fluid position-absolute color-shape-2 z-5">
                                </li>
                                <li class="layer" data-depth="0.03">
                                    <img src="{{ asset('front') }}/assets/img/color-shape/feature-3.svg" alt="shape"
                            ...
                            <div
                                ...
                                <div class="position-relative w-75 mx-auto">
                                    <img class="position-relative z-2 w-100 h-auto"
                                        ...
                                        alt="Image Description">
                                    <img class="position-absolute half-screen"
                                        src="{{ asset('front') }}/assets/img/screen/app-screen-2.jpg"
                                        alt="Image Description">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="section-heading text-center" data-aos="fade-up">
                            ...
                            <p>Phosfluorescently enabled growth strategies after worldwide proactive partnerships
                                cooperative convergence via
                        ...
                        <div class="setup-process-wrap">
                            <ul class="setup-process-list list-unstyled text-center mb-0">
                                <li class="setup-process-item py-4 px-2" data-aos="fade-up">
                                    ...
                                    <span
                                        class="process-tag badge bg-primary-soft py-1 px-3 small fw-bold text-primary rounded-custom">Step
                                        1</span>
        ...
        <section class="pricing-section position-relative overflow-hidden bg-dark text-white pt-120"
            style="background: url('assets/img/page-header-bg.svg')no-repeat center center">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="section-heading text-center z-5 position-relative" data-aos="fade-up">
                            ...
                            <p>Objectively market-driven intellectual capital rather than covalent best practices
                                facilitate strategic information before innovation. </p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                        ...
                        <div
                            ...
                            <div class="price-feature-col pricing-feature-info left-radius bg-primary-soft p-5">
                                <ul class="list-unstyled pricing-feature-list pricing-included-list mb-0"
                                    data-aos="fade-left">
                                    <li class="py-1"><i class="fas fa-check-circle text-primary me-2"></i>
                                        Unlimited
                                        domains</li>
                                    <li class="py-1"><i
                                            class="fas fa-check-circle text-primary me-2"></i>Unlimited
                                        notifications</li>
                                    <li class="py-1"><i class="fas fa-check-circle text-primary me-2"></i>
                                        10,000 unique
                                        visitors</li>
                            ...
                            <div class="price-feature-col pricing-action-info p-5" data-aos="fade-right">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade active show" id="pills-home" role="tabpanel"
                                        ...
                                        <p>Professionally integrate principle-centered intellectual capital whereas
                                            equity.</p>
                                        <div class="pricing-price mt-5">
                                            <h4 class="h1 fw-bold">$49 <span>/Month</span></h4>
                                        </div>
                                        <a href="front/request-demo.html" class="btn btn-primary mt-3">Start 14-Days
                                            Trial</a>
                                    </div>
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                        aria-labelledby="pills-profile-tab">
                                        <h3 class="h5">Pro Yearly</h3>
                                        <p>Uniquely engineer prospective alignments without clicks-and-mortar
                                            innovation.</p>
                                        <div class="pricing-price mt-5">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="section-heading text-center" data-aos="fade-up">
                            ...
                            <p>Efficiently network cross-unit paradigms for premier technologies scale 24/7 paradigms
                                for process-centric data interoperable.</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5" data-aos="fade-up" data-aos-delay="50">
                            ...
                            <div class="faq-info">
                                ...
                                <p class="mb-0">Collaboratively iterate high-payoff content via high
                                    standards in
                                    technology.
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="faq-info">
                                ...
                                <p class="mb-0">Globally e-enable plug-and-play imperatives and seamless
                                    e-markets.
                                    Intrinsicly
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5" data-aos="fade-up" data-aos-delay="150">
                            <span class="faq-icon me-3"><i
                                    class="fal fa-clipboard-list-check text-primary"></i></span>
                            <div class="faq-info">
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="faq-info">
                                ...
                                <p class="mb-0">Progressively pontificate quality vectors without resource
                                    maximizing
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5" data-aos="fade-up" data-aos-delay="250">
                            ...
                            <div class="faq-info">
                                ...
                                <p class="mb-0">Maximizing e-enable imperatives and seamless e-markets.
                                    Intrinsicly
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="faq-content-wrap d-flex mb-5" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="faq-info">
                                ...
                                <p class="mb-0">Conveniently maximize turnkey sound supply chains through
                                    distributed
                                    strategic theme areas. Appropriately cultivate innovative web-readiness whereas.</p>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-lg-3">
                            <div class="text-lg-end">
                                <a href="front/contact-us.html" class="btn btn-light">Get in Touch</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-container testimonialSwiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                        <img src="{{ asset('front') }}/assets/img/testimonial/quotes-dot.svg"
                                            alt="quotes" width="100"
                                            class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                        <div class="d-flex mb-32 align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/testimonial/1.jpg"
                                        ...
                                        <img src="{{ asset('front') }}/assets/img/testimonial/quotes.svg"
                                    ...
                                    <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                        <img src="{{ asset('front') }}/assets/img/testimonial/quotes-dot.svg"
                                            ...
                                            class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                        <div class="d-flex mb-32 align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/testimonial/3.jpg"
                                                class="img-fluid me-3 rounded" width="60" alt="user">
                                            <div class="author-info">
                                    ...
                                    <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                        <img src="{{ asset('front') }}/assets/img/testimonial/quotes-dot.svg"
                                            ...
                                            class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                        <div class="d-flex mb-32 align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/testimonial/2.jpg"
                                                class="img-fluid me-3 rounded" width="60" alt="user">
                                            <div class="author-info">
                                                <h6 class="mb-0">Mr.Rupan Oberoi</h6>
                                        ...
                                        <blockquote>
                                            ...
                                            Appropriately negotiate interactive niches rather than parallel strategic
                                            theme incubate premium total linkage areas.
                                        </blockquote>
                                        <ul class="review-rate mb-0 mt-2 list-unstyled list-inline">
                                            <li class="list-inline-item"><i class="fas fa-star text-warning"></i></li>
                                            <li class="list-inline-item"><i class="fas fa-star text-warning"></i></li>
                                    ...
                                    <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                        <img src="{{ asset('front') }}/assets/img/testimonial/quotes-dot.svg"
                                            ...
                                            class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                        <div class="d-flex mb-32 align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/testimonial/4.jpg"
                                                class="img-fluid me-3 rounded" width="60" alt="user">
                                            <div class="author-info">
                                    ...
                                    <div class="swiper-slide border border-2 p-5 rounded-custom position-relative">
                                        <img src="{{ asset('front') }}/assets/img/testimonial/quotes-dot.svg"
                                            ...
                                            class="img-fluid position-absolute left-0 top-0 z--1 p-3">
                                        <div class="d-flex mb-32 align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/testimonial/5.jpg"
                                                class="img-fluid me-3 rounded" width="60" alt="user">
                                            <div class="author-info">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                                    <div class="footer-single-col">
                                        ...
                                        <ul class="list-unstyled footer-nav-list mb-lg-0">
                                            <li><a href="front/index.html" class="text-decoration-none">Home</a></li>
                                            <li><a href="front/about-us.html" class="text-decoration-none">About Us</a>
                                            </li>
                                            <li><a href="front/services.html" class="text-decoration-none">Services</a>
                                            </li>
                                            <li><a href="front/career.html" class="text-decoration-none">Career</a>
                                            </li>
                                            <li><a href="front/integrations.html"
                                                    class="text-decoration-none">Integrations</a>
                                            </li>
                                            <li><a href="front/integration-single.html"
                                ...
                                <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                                    <div class="footer-single-col">
                                        <h3>Pages</h3>
                                        <ul class="list-unstyled footer-nav-list mb-lg-0">
                                            <li><a href="front/pricing.html" class="text-decoration-none">Pricing</a>
                                            </li>
                                            <li><a href="front/blog.html" class="text-decoration-none">Blog</a></li>
                                            <li><a href="front/blog-single.html" class="text-decoration-none">Blog
                                                    Details</a>
                                            </li>
                                            <li><a href="front/contact-us.html"
                                                    class="text-decoration-none">Contact</a></li>
                                            <li><a href="front/career-single.html" class="text-decoration-none">Career
                                                    Single</a>
                                            </li>
                                            <li><a href="front/service-single.html"
                                                    class="text-decoration-none">Services
                                                    Single</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                                    <div class="footer-single-col">
                                        ...
                                        <ul class="list-unstyled footer-nav-list mb-lg-0">
                                            <li><a href="front/contact-us.html"
                                                    class="text-decoration-none">Contact</a></li>
                                            <li><a href="front/support.html" class="text-decoration-none">Support</a>
                                            </li>
                                            <li><a href="front/support-single.html"
                                                    class="text-decoration-none">Support
                                                    Single</a></li>
                                            <li><a href="front/team.html" class="text-decoration-none">Our Team</a>
                                            </li>
                                            <li><a href="front/client-review.html"
                                                    class="text-decoration-none">Customer
                                                    Review</a></li>
                                            <li><a href="front/career-single.html" class="text-decoration-none">Career
                                                    Single</a>
                                            </li>
                        ...
                        <div class="col-md-7 col-lg-7">
                            <div class="copyright-text">
                                <p class="mb-lg-0 mb-md-0">&copy; 2021 Quiety Rights Reserved. Designed By <a
                                        href="https://themetags.com/" class="text-decoration-none">Programmers
                                        Caffe</a>
                                </p>
                            </div>
                        </div>
